<?php 
	$justintime_instances = WebinarSysteem::getJustinTimeInstances($post->ID);
...
?>
	<div class = "row">
		<div class="col-sm-12">
            ...
            <?php
            if (!empty($_REQUEST['error']) && $_REQUEST['error'] == 'inputday') { ?>
		...
		<div class="col-sm-12" id="input-time">
            ...
            <?php
            if (!empty($_REQUEST['error']) && $_REQUEST['error'] == 'inputtime') { ?>
