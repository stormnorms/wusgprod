...
class WSAWeberException extends Exception { }
 ...
 * @version $id$
 */
class WSAWeberAPIException extends WSAWeberException {
 ...
 * @version $id$
 */
class WSAWeberResourceNotImplemented extends WSAWeberException {
 ...
 * @version $id$
 */
class WSAWeberMethodNotImplemented extends WSAWeberException {
 ...
 * @version $id$
 */
class WSAWeberOAuthException extends WSAWeberException {
 ...
 * @version $id$
 */
class WSAWeberOAuthDataMissing extends WSAWeberException {
 ...
 * @version $id$
 */
class WSAWeberResponseError extends WSAWeberException {
