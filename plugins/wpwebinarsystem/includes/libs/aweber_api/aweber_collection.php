<?php
class WSAWeberCollection extends WSAWeberResponse implements ArrayAccess, Iterator, Countable {
    ...
    public function create($kv_pairs) {
        ...
        return new WSAWeberEntry($resource_data, $url, $this->adapter);
    }
    ...
    public function offsetGet($offset) {
        ...
        return new WSAWeberEntry($entry, $entry_url, $this->adapter);
    }
