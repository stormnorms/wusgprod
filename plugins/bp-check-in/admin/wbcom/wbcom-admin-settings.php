...
if ( !class_exists( 'Wbcom_Admin_Settings' ) ) {
	...
	class Wbcom_Admin_Settings {
		...
		public function wbcom_all_free_plugins() {
			$free_plugins = array(
				'0'	 => array(
					'name'			 => esc_html__( 'Custom Font Uploader', 'bp-checkins' ),
					'slug'			 => 'custom-font-uploader',
					'description'	 => esc_html__( 'It also allows you to upload your own custom font to your site and use them using custom css.', 'bp-checkins' ),
				...
				'1'	 => array(
					'name'			 => esc_html__( 'BuddyPress Activity Filter', 'bp-checkins' ),
					'slug'			 => 'bp-activity-filter',
					'description'	 => esc_html__( 'Admin can set default and customised activities to be listed on front-end.', 'bp-checkins' ),
				...
				'2'	 => array(
					'name'			 => esc_html__( 'BuddyPress Activity Social Share', 'bp-checkins' ),
					'slug'			 => 'bp-activity-social-share',
					'description'	 => esc_html__( 'This plugin allows anyone easily share BuddyPress Activites on major social media (Facebook, Twitter, Google+, Linkedin ).', 'bp-checkins' ),
				...
				'3'	 => array(
					'name'			 => esc_html__( 'BuddyPress Create Group Type', 'bp-checkins' ),
					'slug'			 => 'bp-create-group-type',
					'description'	 => esc_html__( 'It will help to create group type for BuddyPress Groups.', 'bp-checkins' ),
				...
				'4'	 => array(
					'name'			 => esc_html__( 'BuddyPress Member Reviews', 'bp-checkins' ),
					'slug'			 => 'bp-user-profile-reviews',
					'description'	 => esc_html__( 'This plugin allows only site members to add reviews to the buddypress members on the site and even rate the member’s profile out of 5 points with multiple review criteria.', 'bp-checkins' ),
				...
				'5'	 => array(
					'name'			 => esc_html__( 'BuddyPress Group Reviews', 'bp-checkins' ),
					'slug'			 => 'review-buddypress-groups',
					'description'	 => esc_html__( 'This plugin allows the BuddyPress Members to give reviews to the BuddyPress groups on the site. The review form allows the users to give text review, even rate the group on the basis of multiple criterias.', 'bp-checkins' ),
				...
				'6'	 => array(
					'name'			 => esc_html__( 'BuddyPress Favorite Notification', 'bp-checkins' ),
					'slug'			 => 'bp-favorite-notification',
					'description'	 => esc_html__( 'BuddyPress Favorite Notification adds a notification for BuddyPress activity.', 'bp-checkins' ),
				...
				'7'	 => array(
					'name'			 => esc_html__( 'Custom Email Options', 'bp-checkins' ),
					'slug'			 => 'custom-email-options',
					'description'	 => esc_html__( 'Override default email options of Worpdress.', 'bp-checkins' ),
				...
				'8'	 => array(
					'name'			 => esc_html__( 'BuddyPress Checkins', 'bp-checkins' ),
					'slug'			 => 'bp-check-in',
					'description'	 => esc_html__( 'This plugin allows BuddyPress members to share their location when they are posting activities, you can add places where you visited, nearby locations based on google places.', 'bp-checkins' ),
				...
				'9'	 => array(
					'name'			 => esc_html__( 'BuddyPress Job Manager', 'bp-checkins' ),
					'slug'			 => 'bp-job-manager',
					'description'	 => esc_html__( 'Incorporates BuddyPress with the WP Job Manager plugin by creating specific tabs in employer’s and candidate’s profiles.', 'bp-checkins' ),
				...
				'10' => array(
					'name'			 => esc_html__( 'BuddyPress user ToDo List', 'bp-checkins' ),
					'slug'			 => 'bp-user-to-do-list',
					'description'	 => esc_html__( 'This plugin allows you to create your personal task list with timestamp. You can mark them complete when you are done with them. It will also send reminder when you have any overdue task.', 'bp-checkins' ),
				...
				'11' => array(
					'name'			 => esc_html__( 'Shortcodes for BuddyPress', 'bp-checkins' ),
					'slug'			 => 'shortcodes-for-buddypress',
					'description'	 => esc_html__( 'This plugin will add an extended feature to the big name “BuddyPress” that will generate Shortcode for Listing Activity Streams , Members and Groups on any post/page in website.', 'bp-checkins' ),
				...
				'12' => array(
					'name'			 => esc_html__( 'Woo Open Graph', 'bp-checkins' ),
					'slug'			 => 'woo-open-graph',
					'description'	 => esc_html__( 'This plugin will add an extended feature to the big name “WooCommerce” that will adds well executed and accurate Open Graph Meta Tags to your site with title,description and WooCommerce featured image.', 'bp-checkins' ),
				...
				'13' => array(
					'name'			 => esc_html__( 'BuddyPress Lock', 'bp-checkins' ),
					'slug'			 => 'lock-my-bp',
					'description'	 => esc_html__( 'This plugin allows the administrator to lock the certain parts of their site. It help to create private BuddyPress community by locking certain BuddyPress Components, WordPress Pages, Custom Post Types for public view without using any membership plugin.', 'bp-checkins' ),
					'status'		 => $this->wbcom_plugin_status( 'lock-my-bp' ),
					'wp_url'		 => 'https://wordpress.org/plugins/lock-my-bp/',
					'icon'			 => 'fas fa-2x fa-lock'
				),
				'14' => array(
					'name'			 => esc_html__( 'Woo Audio Preview', 'bp-checkins' ),
					'slug'			 => 'woo-audio-preview',
					'description'	 => esc_html__( 'This plugin Allows playing the audio files in sample mode to prevent unauthorized downloading of the audio files. It helps to display sample files at single product page.', 'bp-checkins' ),
				...
				'15' => array(
					'name'			 => esc_html__( 'WordPress System Log', 'bp-checkins' ),
					'slug'			 => 'wp-system-log',
					'description'	 => esc_html__( 'This plugin helps administrators of the site see their environment on which the site is currently running that includes WordPress environment, tha database it requires, Server Environment and the plugins installed and activated on the site.', 'bp-checkins' ),
					'status'		 => $this->wbcom_plugin_status( 'wp-system-log' ),
					'wp_url'		 => 'https://wordpress.org/plugins/wp-system-log/',
					'icon'			 => 'fas fa-2x fa-file-alt'
				),
				'16' => array(
					'name'			 => esc_html__( 'BP Post From Anywhere', 'bp-checkins' ),
					'slug'			 => 'bp-post-from-anywhere',
					'description'	 => esc_html__( 'This plugin will generate shortcode and widgets for post updates section for activities so you can post update from anywhere, it might be sidebar, some page or any template file.', 'bp-checkins' ),
				...
				'17' => array(
					'name'			 => esc_html__( 'Woo Document Preview', 'bp-checkins' ),
					'slug'			 => 'woo-document-preview',
					'description'	 => esc_html__( 'This will allow you to add document preview at single product page. Which helps to offer more better idea when you are selling ebooks, pdf or some documents.', 'bp-checkins' ),
				...
				'18' => array(
					'name'			 => esc_html__( 'WordPress Media Category', 'bp-checkins' ),
					'slug'			 => 'media-category',
					'description'	 => esc_html__( 'This plugin helps administrators of the site categorize their wordpress media.', 'bp-checkins' ),
					'status'		 => $this->wbcom_plugin_status( 'media-category' ),
					'wp_url'		 => 'https://wordpress.org/plugins/media-category/',
					'icon'			 => 'fas fa-2x fa-images'
				),
				'19' => array(
					'name'			 => esc_html__( 'Woo Price Quotes', 'bp-checkins' ),
					'slug'			 => 'woo-price-quote-inquiry',
					'description'	 => esc_html__( 'This plugin helps in quoting the products that admin wishes to hide its purchasing details.', 'bp-checkins' ),
				...
				'20' => array(
					'name'			 => esc_html__( 'EDD Service Extended', 'bp-checkins' ),
				...
				'21' => array(
					'name'			 => esc_html__( 'WB Ads Rotator with Split Test', 'bp-checkins' ),
					'slug'			 => 'wb-ads-rotator-with-split-test',
					'description'	 => esc_html__( 'This plugin is designed for the SPLIT TESTING, you can check performance of your ads layout and on the basis of them you can select one of them for your regular use.', 'bp-checkins' ),
		...
		public function wbcom_all_paid_plugins() {
			$paid_plugins = array(
				'0'	 => array(
					'name'			 => esc_html__( 'BuddyPress Moderation Pro', 'bp-checkins' ),
					'description'	 => esc_html__( 'BuddyPress Community Moderation offers a solution for site owners to keep their communities straight. With community policing strategy, members of the community have an option for moderation sitewide by attaching flags to content created within the various components.', 'bp-checkins' ),
					'download_url'	 => 'https://wbcomdesigns.com/downloads/buddypress-moderation-pro/',
					'icon'			 => 'fas fa-2x fa-exclamation-triangle'
				),
				'1'	 => array(
					'name'			 => esc_html__( 'BuddyPress Polls', 'bp-checkins' ),
					'description'	 => esc_html__( 'Use BuddyPress Polls plugin to create polls inside the activity, let your user response to your polls. Members can create pools like activities, easily votes on them.', 'bp-checkins' ),
					'download_url'	 => 'https://wbcomdesigns.com/downloads/buddypress-polls/',
					'icon'			 => 'fas fa-2x fa-poll'
				),
				'2'	 => array(
					'name'			 => esc_html__( 'BuddyPress Resume Manager', 'bp-checkins' ),
					'description'	 => esc_html__( 'BuddyPress Resume Manager adds a separate BuddyPress Resume menu at a user’s BuddyPress Profile Page to display individual member resume. We have added predefined fields for the resumes and site admin and enable and disable them.', 'bp-checkins' ),
					'download_url'	 => 'https://wbcomdesigns.com/downloads/buddypress-resume-manager/',
					'icon'			 => 'fas fa-2x fa-file'
				),
				'3'	 => array(
					'name'			 => esc_html__( 'BuddyPress Profanity', 'bp-checkins' ),
					'description'	 => esc_html__( 'Use BuddyPress Profanity plugin to censor content in your community! Easily Censor all the unwanted words in activities, private messages contents by specifying a list of keywords to be filtered.', 'bp-checkins' ),
					'download_url'	 => 'https://wbcomdesigns.com/downloads/buddypress-profanity/',
					'icon'			 => 'fab fa-2x fa-galactic-republic'
				),
				'4'	 => array(
					'name'			 => esc_html__( 'BuddyPress Private Community Pro', 'bp-checkins' ),
					'description'	 => esc_html__( 'This plugin offers a lockdown for BuddyPress Component and will ask users to log in go further to check profile or any other protected details.', 'bp-checkins' ),
					'download_url'	 => 'https://wbcomdesigns.com/downloads/buddypress-private-community-pro/',
					'icon'			 => 'fas fa-2x fa-user-lock'
				),
				'5'	 => array(
					'name'			 => esc_html__( 'BuddyPress Profile Pro', 'bp-checkins' ),
					'description'	 => esc_html__( 'This plugin gives you the power to extend BuddyPress Profiles with repeater fields and groups. You can easily add multiple field groups and display them at member’s profile.', 'bp-checkins' ),
		...
		public function wbcom_enqueue_admin_scripts() {
			...
			if ( !wp_script_is( 'wbcom_admin_setting_js', 'enqueued' ) ) {
				...
				wp_register_script(
				$handle		 = 'wbcom_admin_setting_js', $src		 = BPCHK_PLUGIN_URL . 'admin/wbcom/assets/js/wbcom-admin-setting.js', $deps		 = array( 'jquery' ), $ver		 = time(), $in_footer	 = true
				);
				wp_localize_script(
				'wbcom_admin_setting_js', 'wbcom_plugin_installer_params', array(
					'ajax_url'			 => admin_url( 'admin-ajax.php' ),
					'activate_text'		 => esc_html__( 'Activate', 'bp-checkins' ),
					'deactivate_text'	 => esc_html__( 'Deactivate', 'bp-checkins' )
				)
				);
			...
			if ( !wp_style_is( 'wbcom-admin-setting-css', 'enqueued' ) ) {
				wp_enqueue_style( 'wbcom-admin-setting-css', BPCHK_PLUGIN_URL . 'admin/wbcom/assets/css/wbcom-admin-setting.css' );
			}
			...
			if ( function_exists( 'get_current_screen' ) ) {
				...
				if ( 'toplevel_page_wbcomplugins' === $screen->base ) {
					...
					if ( !wp_style_is( 'wbcom-selectize-css', 'enqueued' ) ) {
						wp_enqueue_style( 'wbcom-selectize-css', BPCHK_PLUGIN_URL . 'admin/css/selectize.css' );
					}
					if ( !wp_script_is( 'wbcom-selectize-js', 'enqueued' ) ) {
						wp_enqueue_script( 'wbcom-selectize-js', BPCHK_PLUGIN_URL . 'admin/js/selectize.min.js', array( 'jquery' ) );
					}
					wp_enqueue_style( 'bp-checkins', BPCHK_PLUGIN_URL . 'admin/css/bp-checkins-admin.css', array(), time(), 'all' );
					wp_enqueue_script( 'bp-checkins', BPCHK_PLUGIN_URL . 'admin/js/bp-checkins-admin.js', array( 'jquery' ), time(), false );
		...
		public function wbcom_admin_additional_pages() {
			add_submenu_page(
			'wbcomplugins', esc_html__( 'Components', 'bp-checkins' ), esc_html__( 'Components', 'bp-checkins' ), 'manage_options', 'wbcom-plugins-page', array( $this, 'wbcom_plugins_submenu_page_callback' )
			);
			add_submenu_page(
			'wbcomplugins', esc_html__( 'Themes', 'bp-checkins' ), esc_html__( 'Themes', 'bp-checkins' ), 'manage_options', 'wbcom-themes-page', array( $this, 'wbcom_themes_submenu_page_callback' )
			);
			add_submenu_page(
			'wbcomplugins', esc_html__( 'Support', 'bp-checkins' ), esc_html__( 'Support', 'bp-checkins' ), 'manage_options', 'wbcom-support-page', array( $this, 'wbcom_support_submenu_page_callback' )
			);
		}
		...
		public function wbcom_admin_setting_header_html() {
			...
			<div id="wb_admin_header" class="wp-clearfix">
				...
				<div id="wb_admin_logo">
					<img src="<?php echo BPCHK_PLUGIN_URL . 'admin/wbcom/assets/imgs/logowbcom.png'; ?>">
					...
					<ul>
						<li class="wb_admin_nav_item <?php echo esc_attr( $settings_active ); ?>">
							<a href="<?php echo get_admin_url() . 'admin.php?page=wbcomplugins'; ?>" id="wb_admin_nav_trigger_settings">
								...
								<h4><?php esc_html_e( 'Settings', 'bp-checkins' ); ?></h4>
							</a>
						</li>
						<li class="wb_admin_nav_item <?php echo esc_attr( $plugin_active ); ?>">
							<a href="<?php echo get_admin_url() . 'admin.php?page=wbcom-plugins-page'; ?>" id="wb_admin_nav_trigger_extensions">
								<i class="fas fa-th"></i>
								<h4><?php esc_html_e( 'Components', 'bp-checkins' ); ?></h4>
							</a>
						</li>
						<li class="wb_admin_nav_item <?php echo esc_attr( $theme_active ); ?>">
							<a href="<?php echo get_admin_url() . 'admin.php?page=wbcom-themes-page'; ?>" id="wb_admin_nav_trigger_themes">
								...
								<h4><?php esc_html_e( 'Themes', 'bp-checkins' ); ?></h4>
							</a>
						</li>
						<li class="wb_admin_nav_item <?php echo esc_attr( $support_active ); ?>">
							<a href="<?php echo get_admin_url() . 'admin.php?page=wbcom-support-page'; ?>" id="wb_admin_nav_trigger_support">
								...
								<h4><?php esc_html_e( 'Support', 'bp-checkins' ); ?></h4>
							</a>
						</li>
