...
if (!class_exists('ElfsightPdfEmbedPlugin')) {
    class ElfsightPdfEmbedPlugin {
        private $name;
        private $slug;
        private $version;
        private $textDomain;
        ...
        public function __construct($config) {
            ...
            $this->update = new ElfsightPdfEmbedPluginUpdate($this->updateUrl, $this->version, $this->pluginSlug, $this->purchaseCode);
            $this->widgetsApi = new ElfsightPdfEmbedWidgetsApi($this->slug, $this->pluginFile, $this->textDomain);
            $this->admin = new ElfsightPdfEmbedPluginAdmin($config, $this->widgetsApi);
            $this->widget = new ElfsightPdfEmbedWidget($config, $this->widgetsApi);
            $this->vcElement = new ElfsightPdfEmbedVCElement($config, $this->widgetsApi);
