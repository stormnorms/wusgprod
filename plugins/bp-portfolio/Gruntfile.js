...
module.exports = function ( grunt ) {
    ...
    grunt.initConfig( {
        ...
        cssmin: {
            ...
            target: {
                files: {
                    'assets/css/bp-portfolio-combined.css': [
                        // 'assets/css/select2.min.css',
                        'assets/css/magnific-popup.css',
                        'assets/css/bp-portfolio.css'
                    ]
                }
            }
        },
        ...
        uglify: {
            ...
            frontend: {
                src: [
                    ...
                    'assets/js/bp-portfolio.js',
                ],
                dest: 'assets/js/bp-portfolio-combined.js'
            }
        },
        /*
         * Check text domain
        ...
        checktextdomain: {
            options: {
                text_domain: [ 'bp-portfolio' ], //Specify allowed domain(s)
        ...
        makepot: {
            target: {
                options: {
                    ...
                    potFilename: 'bp-portfolio.pot', // Name of the POT file.
