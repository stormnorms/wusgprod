...
<?php if( bpcp_is_accessible() ){ ?>
    ...
    <form class="add-project-details standard-form new"  method="post" action="">
        <div>
            <label for="project_title"><?php _e( 'Title (required)', 'bp-portfolio-pro' ); ?></label>
        ...
        <div>
            <label for="project_description"><?php _e( 'Description', 'bp-portfolio-pro' ); ?></label>
        ...
        <div>
            <label for="project_tags"><?php _e( 'Tags', 'bp-portfolio-pro' ); ?></label>
        ...
        <div class="bpcp-buttons">
            <input id="create_project" class="create-project" type="submit" name="create_project" value="<?php if(!empty($project_id)) { _e( 'Update Project', 'bp-portfolio-pro' ); } else { _e( 'Add Project and Continue', 'bp-portfolio-pro' ); } ?>" />
        </div>
    </form>
