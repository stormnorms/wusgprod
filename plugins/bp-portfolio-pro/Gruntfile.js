...
module.exports = function ( grunt ) {
    ...
    grunt.initConfig( {
        ...
        cssmin: {
            ...
            target: {
                files: {
                    'assets/css/bp-portfolio-pro-combined.css': [
                        'assets/css/magnific-popup.css',
                        'assets/css/bp-portfolio-pro.css'
                    ]
                }
            }
        },
        ...
        uglify: {
            ...
            frontend: {
                src: [
                    ...
                    'assets/js/bp-portfolio-pro.js',
                ],
                dest: 'assets/js/bp-portfolio-pro-combined.js'
            }
        },
        /*
         * Check text domain
        ...
        checktextdomain: {
            options: {
                text_domain: [ 'bp-portfolio-pro' ], //Specify allowed domain(s)
        ...
        makepot: {
            target: {
                options: {
                    ...
                    potFilename: 'bp-portfolio-pro.pot', // Name of the POT file.
    ...
    // register task
    grunt.registerTask( 'default', [ 'cssmin', 'uglify', 'checktextdomain', 'makepot', 'potomo', 'rtlcss' ] );
