        ...
        public static function options_page() {
            ...
            <div class="wrap woocommerce">
                ...
                <table class="form-table">
                    ...
                    <?php 
                    $attachment_method_array = array( '0' => 'Attach PDF to email', '1' => 'Attach PDF to email and include link to download PDF', '2' => 'Only include link to download PDF' ); 
                    ...
                    <tr valign="top">
                        <th scope="row" class="titledesc">
                            ...
                            <img class="help_tip woocommerce-help-tip" data-tip="<?php echo sprintf( __("Add a logo to your PDF, otherwise it will just use your WordPress title %s", 'woocommerce-pdf-invoice' ), get_bloginfo( 'name' ) ); ?>" src="<?php echo plugins_url( 'woocommerce/assets/images/help.png' );?>" height="16" width="16" />                 
                        </th>
                        <td class="forminp forminp-number">
