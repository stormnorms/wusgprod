			...
			if($shape_divider=='wave' && !empty($settings['wave_loop_shape'])){
				...
				foreach($settings['wave_loop_shape'] as $item) {
					...
					if(!empty($item['shape_color_type']) && $item['shape_color_type']=='gradient'){
						$color_1 = ($item['shape_color']!='') ? $item['shape_color'] : '#8072fc';
						$color_2 = ($item['shape_color_2']!='') ? $item['shape_color_2'] : '#6fc784';
						$gradient_x1 = ($item['gradient_x1']["size"]!='') ? $item['gradient_x1']["size"].$item['gradient_x1']["unit"] : '0';
						$gradient_x2 = ($item['gradient_x2']["size"]!='') ? $item['gradient_x2']["size"].$item['gradient_x2']["unit"] : '70%';
						$gradient_y1 = ($item['gradient_y1']["size"]!='') ? $item['gradient_y1']["size"].$item['gradient_y1']["unit"] : '0';
						$gradient_y3 = ($item['gradient_y2']["size"]!='') ? $item['gradient_y2']["size"].$item['gradient_y2']["unit"] : '50%';
