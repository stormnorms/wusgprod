	...
	class buddyboss_theme_Redux_Framework_config {
		...
		public function setSections() {
			...
			$style_elements = array(
				...
				array( 'slug' => 'buddyboss_theme_group_cover_bg', 'title' => 'Cover Image Background', 'subtitle' => 'Only visible if you have enabled Group cover images in the <a href="javascript:void(0);" class="redux-group-tab-link-a" data-key="4" data-rel="11">Cover Images</a> options area.', 'desc' => '', 'type' => 'color', 'default' => '#607387' ),
			...
			$this->sections[] = array(
				...
				'fields'     => array(
					...
					array(
						...
						'subtitle' => __( 'You can optionally upload your own image to always use a default cover photo. Ideal size is 1300px by 225px or larger.',
							'buddyboss-theme' ),
						'url'      => false,
					),
					array(
